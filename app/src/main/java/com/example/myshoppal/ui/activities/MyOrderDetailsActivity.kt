...
class MyOrderDetailsActivity : AppCompatActivity() {
    ...
    private fun setupUI(orderDetails: Order) {
        ...
        // Date Format in which the date will be displayed
        ...
        val diffInHours: Long = TimeUnit.MILLISECONDS.toHours(diffInMilliSeconds)
                // The store takes 3 hours to deliver the product
        when {
            diffInHours < 1 -> { // Processing the order
            ...
            diffInHours < 2 -> { // Pending the order
